...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <div>
            <h2 class="text-2xl font-semibold leading-tight">User Verification</h2>
        </div>
                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">{{ $user->nomor_str }}</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <span
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                ...
                                <form action="{{ route('superadmin.users.reject', $user) }}" method="POST" class="inline-block ml-4">
                                    @csrf
                                    @method('DELETE')
