    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <nav class="flex items-center space-x-2 text-sm text-gray-600 mb-4">
                ...
                <span class="text-gray-900">Edit Makanan</span>
            </nav>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-8">Edit Menu Makanan: {{ $food->name }}</h2>

                <form action="{{ secure_url(route('superadmin.foods.update', $food)) }}" method="POST">
                    @csrf
                    @method('PATCH')
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number"
                                       ...
                                       id="vitamin_c_mg"
                                       name="vitamin_c_mg"
                                       value="{{ old('vitamin_c_mg', $food->vitamin_c_mg) }}"
                            ...
                            <div>
                                ...
                                <input type="number"
                                       ...
                                       id="besi_mg"
                                       name="besi_mg"
                                       value="{{ old('besi_mg', $food->besi_mg) }}"
                            ...
                            <!-- Zinc (Seng) -->
                            <div>
                                <label for="seng_mg" class="block text-sm font-medium text-gray-700 mb-2">
                                    Zinc (Seng)
                                </label>
                                <input type="number"
                                       step="0.1"
                                       id="seng_mg"
                                       name="seng_mg"
                                       value="{{ old('seng_mg', $food->seng_mg) }}"
                                       class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('seng_mg') border-red-500 @enderror"
                                       required>
                                @error('seng_mg')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="lg:col-span-1">
                            <div class="sticky top-8">
                                ...
                                <input type="url"
                                       id="urlimage"
                                       name="urlimage"
                                       value="{{ old('urlimage', $food->urlimage) }}"
                                       placeholder="URL..."
                                ...
                                <div class="mt-4">
                                    <div id="image-preview-container" class="w-full h-64 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50">
                                        <!-- Default state -->
                                        <div id="default-preview" class="text-center text-gray-400 {{ $food->urlimage ? 'hidden' : '' }}">
                                        ...
                                        <img id="preview-img"
                                             src="{{ $food->urlimage }}"
                                             alt="Preview"
                                             class="{{ $food->urlimage ? '' : 'hidden' }} w-full h-full object-cover rounded-lg">
